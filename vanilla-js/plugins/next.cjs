/**
 * @file Next.js plugin wrapper for auto-syncing avatar-skin model assets with Turbopack and Webpack support (CommonJS).
 * @module plugins/next
 */
...
/**
 * Next.js configuration enhancer higher-order function (CommonJS).
 *
